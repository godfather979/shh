...
const API_KEY = "AIzaSyDWZbJmy5ral2viflRAzxaYs96E9JQ-Ya8";
...
const Chatbot = ({ mockJson }) => {
  ...
  const [position, setPosition] = useState({ x: 180, y: 20 });
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const generalContext = `You are a legal AI assistant. Respond in clear, helpful manner. Use Markdown formatting for steps or emphasis.`;
      ...
      {isOpen && (
        ...
        >
          <div className="bg-white rounded-xl shadow-2xl border border-slate-300 overflow-hidden flex flex-col h-[500px]">
            ...
            >
              <span className="font-semibold">🧑‍⚖️ Legal Assistant</span>
              <FaTimes
